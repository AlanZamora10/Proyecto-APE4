...
public class APE4_Grafos {
    ...
    static class Grafo {
        ...
        public void agregarNodo(String id, String nombre) {
            // Se registra el nodo en el mapa principal usando su id como clave
            nodos.put(id, new Nodo(id, nombre));
            // Se inicializa su lista de vecinos vacía en el mapa de adyacencia
        ...
        public void agregarArista(String origen, String destino, int peso) {
            // Como el grafo es no dirigido, la conexión se añade en ambos sentidos
        ...
        public List<String> dijkstra(String inicio, String fin) {
            ...
            while (!cola.isEmpty()) {
                ...
                // Optimización: si alcanzamos el nodo fin, podemos terminar el bucle
